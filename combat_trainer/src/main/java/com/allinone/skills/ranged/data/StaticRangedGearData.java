...
public class StaticRangedGearData {
    ...
    public static final LoadoutItem[] AMMO = {
        ...
        new LoadoutItem("Iron arrow"),
        new LoadoutItem("Bronze arrow"),
    };
